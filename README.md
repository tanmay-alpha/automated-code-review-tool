...
| baseline (zero-shot)         | 0.61     | 0.66      | 0.57   | 1,400 ms                |
| Keyword baseline (regex)   | 0.44     | 0.92      | 0.21   | 5 ms                    |

The fine-tuned CodeBERT model is the **winner** on F1 and latency. baseline
